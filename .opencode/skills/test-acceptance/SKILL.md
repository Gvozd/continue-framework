...
When the load-testing session is finished — NOT between iterative re-runs — stop the load infrastructure. It is resource-heavy and, unlike the dev backend, not meant to stay up. See `.opencode/rules/infrastructure.md` "Load-Test Infrastructure".
